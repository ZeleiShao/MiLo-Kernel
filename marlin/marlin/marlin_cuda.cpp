...
void mul_3bit_256_64(
  ...
  int dev = A.get_device();
  int err = marlin_cuda_3bit_256_64(
    A.data_ptr(),
    B1.data_ptr(),
    B2.data_ptr(),
    C.data_ptr(),
...
void mul_3bit_256_64_with_zero(
  ...
  int dev = A.get_device();
  int err = marlin_cuda_3bit_256_64_with_zero(
    A.data_ptr(),
    B1.data_ptr(),
    B2.data_ptr(),
    C.data_ptr(),
...
void mul_3bit_64_256_with_zero(
  ...
  int dev = A.get_device();
  int err = marlin_cuda_3bit_64_256_with_zero(
    A.data_ptr(),
    B1.data_ptr(),
    B2.data_ptr(),
    C.data_ptr(),
